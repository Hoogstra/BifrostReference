...
- [Neutral Factions](#-neutral-factions)
- [Combat Effect Color Legend](#-combat-effect-color-legend)
- [Portals](#-portals)
...
| Realm | Feature |
|-------|---------|
| **Midgard** | 🟩 Standard first realm, limited buildings, no special conditions |
| **Niflheim (Frost)** | 🟨 Map of islands, portals connect them |
|  | 🟨 Winters last 6 months |
|  | 🟪 Extra Town Halls can be repaired |
| **Muspelheim (Fire)** | 🟥 No wood consumption |
|  | 🟥 Volcano center |
|  | 🟥 Rimsteel forging at Anvil of Gods |
|  | 🟩 No iron/stone deposits — must defeat golems |
| **Idavoll (Heat)** | 🟩 Oppressive heat reduces production |
|  | 🟩 Oasis zones give bonuses |
|  | 🟥 Grafvitnir spawns; defeating them grants +10% attack (not persistent) |
| **Nidavellir (Cave)** | 🟩 Ore deposits block slots |
|  | 🟩 Miners extract crowns/stone |
|  | 🟪 Zones fade back into fog if unvisited |
| **Vanaheim (Jungle)** | 🟩 Strong wild creatures reclaim zones |
|  | 🟩 Wolf dens/fox burrows cannot be colonized |
|  | 🟥 Hazardous, frequent attacks |
...
| Tile | Bonus |
|------|-------|
| **Beacon of Light** | 🟩 +2 villagers, +4 max pop |
|  | 🟦 +150 lore |
|  | 🟥 Towers double shot |
|  | 🟥 Exploding towers |
| **Pillar of Glory** | 🟩 -30% colonization cost |
|  | 🟦 +100 fame |
|  | 🟥 Damage-reflecting towers |
|  | 🟥 Multishot towers |
|  | 🟥 First 3 military units free |
| **Wyvern’s Den** | 🟩 +10 stone & +5 iron |
|  | 🟨 +100 food |
|  | 🟩 +100 wood |
|  | 🟩 +75 crowns |
|  | 🟥 +250 military XP |
|  | 🟥 Double towers per zone |
...
| Faction | Realm | Unlock Method | Recruit Option |
|---------|-------|---------------|----------------|
| Jotnar | Midgard | Trade food | ⚪ Build Jotnar camp (100 wood, 3 slots) |
|  |  |  | 🔴 Recruit 1 Jotnar (500 food) |
| Myrkálfar | Muspelheim | Trade wood | ⚪ Build camp (80 wood) |
|  |  |  | 🔴 Recruit fighter (80 crowns, poison ability) |
| Kobolds | Niflheim | Trade food/wood | ⚪ Build camp (50 wood, 30 crowns) |
|  |  |  | 🔴 Recruit fighter (30 crowns) |
| Dwarves | Nidavellir | Trade food/wood | ⚪ Build camp (50 wood, 5 stone) |
|  |  |  | 🔴 Recruit fighter (60 crowns) |
|  |  |  | 🟩 Recruit Operative (100 crowns, mines/forges/fights) |
...
|--------------|---------------|-------------------|---------------|
| **Idavoll** | 🟨 Idavoll Towers | 🟨 Idavoll Barricades | 🟨 Thunder, Holy |
| **Muspelheim** | 🟧 Muspelheim Towers | 🟧 Muspelheim Barricades | 🟧 Fire, 🟨 Storm |
| **Nidavellir** | 🟪 Nidavellir Towers | 🟩 Nidavellir Barricades | 🟪 Terror, 🟩 Venom |
...
## ⚔️ Blades (Weapon Powerups)

| Blade Type | Effect |
|------------|--------|
| **Blood** | 🟥 Units heal when dealing damage (life steal). |
| **Confusion** | 🟪 Units can turn enemies against allies briefly. |
| **Fire** | 🟧 Units burn enemies; trackers gain fire arrows. |
| **Frost** | ⚪ Units freeze enemies and slow attack speed. |
| **Holy** | 🟨 Units blind enemies (miss attacks for 3s). |
| **Storm** | 🟨 Units inflict area damage (AOE). |
| **Terror** | 🟪 Units cause fear (enemies flee). |
| **Thunder** | 🟨 Lightning strike chance (Mjölnir’s wrath). |
...
| Tower Type | Effect |
|------------|--------|
| **Idavoll** | 🟨 Thunder arrows. |
| **Muspelheim** | 🟧 Burning arrows. |
| **Nidavellir** | 🟪 Terror arrows. |
...
## 🛡️ Barricade Upgrades

| Barricade Type | Effect |
|----------------|--------|
| **Idavoll** | 🟨 Lightning damage. |
| **Muspelheim** | 🟧 Burning damage. |
| **Nidavellir** | 🟩 Poison damage. |
